    ...
    const handleSubmit = e => {
        ...
        if(rating){
            ...
            const rJSON = {
                ...
                profile_photo_url:"http://romanroadtrust.co.uk/wp-content/uploads/2018/01/profile-icon-png-898-300x300.png", 
                rating: reviewStars,
                text: reviewText,
            };
            addNewReview(rJSON);
            ...
            document.getElementById("ratingRequired").innerHTML = "Please choose star rating";
        }
    }
    return (
        <div className="addReviewForm">
            <form className="form">
                ...
                <Rater total={5} rating={0} onRate={({rating})=>{
                    setRating(rating);
